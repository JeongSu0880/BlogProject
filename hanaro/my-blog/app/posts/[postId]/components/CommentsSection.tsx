  ...
  return (
    <div className="mt-8">
      ...
      <ul className="mt-4 space-y-4">
        {comments.map((c) => (
          <li key={c.id} className={['p-3', 'border', 'rounded'].join(' ')}>
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="text-right">
                {!c.isDeleted && (c.writer === currentUserId || isAdmin) && (
            ...
            {editing === c.id && (
              <form className="mt-2" onSubmit={(e) => onSubmitEdit(e, c.id)}>
                <textarea
                  value={editContent}
                ...
                />
                <div
                  className={['mt-2', 'flex', 'gap-2', 'justify-end'].join(' ')}
                >
                  <button
                    type="button"
